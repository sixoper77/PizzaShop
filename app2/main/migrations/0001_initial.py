...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'ordering': ['name'],
                'indexes': [models.Index(fields=['id', 'slug'], name='main_produc_id_fd340c_idx'), models.Index(fields=['name'], name='main_produc_name_8c96cd_idx'), models.Index(fields=['-created'], name='main_produc_created_96d03b_idx')],
            },
        ),
    ]
